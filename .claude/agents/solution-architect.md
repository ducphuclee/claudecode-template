...
description: Solution Architect — đưa ra giải pháp kỹ thuật cho vấn đề phức tạp, thiết kế architecture, quyết định tech stack. Gọi khi agents khác bị stuck, khi cần thiết kế hệ thống mới, hoặc khi có trade-off quan trọng cần quyết định.
