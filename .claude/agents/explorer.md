---
name: explorer
description: Explorer - khám phá và hiểu codebase, tìm files/functions liên quan, map architecture. Gọi agent này trước khi implement để hiểu context.
...
### Patterns to Follow
[Code tương tự đã làm như thế nào]
