---
name: doc-writer
description: Documentation Writer — viết và cập nhật technical docs, API docs, READMEs, user guides, architecture docs. Gọi khi cần tạo hoặc cải thiện documentation cho code, API, hoặc hướng dẫn sử dụng.
